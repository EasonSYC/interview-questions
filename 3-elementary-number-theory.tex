...
\begin{problem}
    Define what is meant by a prime. Prove that there are infinitely primes. By considering \(4p_1 p_2 \cdots p_n - 1\), prove that there are infinitely primes of the form \(4n + 3\). Can we use the same proof for the primes of the form \(4n + 1\)?
\end{problem}
